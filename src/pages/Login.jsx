  ...
  return (
    <form className="min-h-[80vh] flex items-center">
      <div className="flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 border rounded-lg text-zinc-600 text-sm shadow-lg">
        ...
        <div className="w-full">
          <p htmlFor="name">Password</p>
          <input className="border border-zinc-300 rounded w-[100%] p-2 mt-1" type="password" onChange={(e)=>setPassword(e.target.value)} value={password} />
        </div>
